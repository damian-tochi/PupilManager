...
import com.bridge.androidtechnicaltest.network.CacheIntercept
import com.bridge.androidtechnicaltest.network.PupilApi
import com.bridge.androidtechnicaltest.network.RetryInterceptor
import com.bridge.androidtechnicaltest.network.hasNetwork
...
class PupilAPIFactory(private val context: Context) {
    fun retrofitPupil(): PupilApi {
        ...
        builder.addInterceptor(RetryInterceptor(context))
